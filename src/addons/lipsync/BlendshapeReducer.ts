 ...
 */
export const ARKIT_BLENDSHAPE_NAMES: readonly string[] = [
  '_neutral',
  'browDownLeft',
  'browDownRight',
  'browInnerUp',
...
const NAME_TO_INDEX = new Map<string, number>(
  ARKIT_BLENDSHAPE_NAMES.map((n, i) => [n, i])
);
...
function read(arr: Float32Array, name: string): number {
 ...
 */
export function blendshapesToVisemes(arr: Float32Array): VisemeWeights {
