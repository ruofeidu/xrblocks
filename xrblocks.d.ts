 ...
 * @version v0.20.0
 * @commitid b47b450
 * @builddate 2026-08-11T06:03:57.199Z
...
declare class AnchorManager extends Script {
     ...
     */
    create(pose: XRRigidTransform, label: string, space?: XRSpace): Promise<TrackedAnchor | null>;
    /**
     ...
     */
    restoreAll(): Promise<AnchorRestoreResult[]>;
    /**
...
declare abstract class UIElement extends Script {
    readonly isUI = true;
...
declare class UICard extends UIElement {
    name: string;
...
declare class UIOverlay extends UIElement {
    name: string;
    readonly appearance: UIAppearance;
...
declare class UIIcon extends UIElement {
    name: string;
...
declare class UIImage extends UIElement {
    name: string;
    readonly ariaLabel?: string;
    private _src;
...
declare class UIPanel extends UIElement {
    name: string;
...
declare class UIText extends UIElement {
    name: string;
    private _text;
...
declare class UISlider extends UIElement {
    name: string;
    readonly ariaLabel: string;
    onInput?: (value: number) => void;
    onChange?: (value: number) => void;
